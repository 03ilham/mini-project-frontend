...
import { doUpdateImagesReq } from "../../redux/actions/HousesImages";
...
export default function UpdateHouse(props) {
  ...
  const onSubmit = (el) => {
    ...
    payload.append('id',props.action.id)
    dispatch(doUpdateImagesReq(payload));
    props.setRefresh(true)
    props.closeModal(true)
    toast.success("Data has been updeted.");
  };
